...
final class SignInView: UIView {
    ...
    private let showPassButton = UIButton(target: SignInView.self, action: #selector(showPassButtonTapped))
    private let signInButton = ReusableAuthButton(title: AuthConstant.Text.singIn, target: SignInView.self, action: #selector(signInButtonTapped))
