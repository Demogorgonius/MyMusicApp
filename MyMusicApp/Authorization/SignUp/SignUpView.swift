...
final class SignUpView: UIView {
    ...
    private let showPassButton = UIButton(target: SignUpView.self, action: #selector(showPassButtonTapped))
    private let signUpButton = ReusableAuthButton(title: AuthConstant.Text.singUp, target: SignUpView.self, action: #selector(signUpButtonTapped))
